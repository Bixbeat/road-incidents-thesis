...
@author: alex
"""
from lib.scraping import bing, google, flickr, utils

if __name__ == '__main__':

## Build queries to automatically feed to APIs
    combinations = utils.get_query_combinations("street","snow")
    extra_terms = ["city"] # Or add a list of synonyms, but this will create very many combinations
    combinations = utils.add_term_to_combinations(combinations, extra_terms)
